...
# -------------------------
st.set_page_config(
    page_title="Streaming Service Insights",
    page_icon="🎬",
    layout="wide"
)
...
if section == "Home":
    ...
    with st.expander("👩‍💻 About the Developer", expanded=False):
        ...
        with col1:
            st.markdown("""
            <div style="color: #f8fafc !important;">
            <h3 style="color: #f8fafc !important;">Hi, I'm Sanaj Jadhav! 👋</h3>
            
            <p style="color: #e2e8f0 !important;">
            A passionate <strong>Data Analyst</strong> and <strong>Visualization Specialist</strong> who transforms complex datasets into 
            compelling stories and actionable insights.
            </p>
            
            <p style="color: #e2e8f0 !important;">
            🎯 <strong>Mission</strong>: Bridge the gap between raw data and strategic decision-making through 
            intuitive visualizations and user-centric design.
            </p>
            
            <h4 style="color: #f8fafc !important;">🛠️ Technical Arsenal</h4>
            </div>
            """, unsafe_allow_html=True)
            ...
            st.markdown("""
            <div style="color: #f8fafc !important;">
            <h4 style="color: #f8fafc !important;">🌟 Core Strengths</h4>
            <ul style="color: #e2e8f0 !important;">
                <li><strong>Data Storytelling</strong>: Converting complex analytics into clear narratives</li>
                <li><strong>Interactive Design</strong>: Creating engaging, user-friendly dashboards</li>
                <li><strong>Problem Solving</strong>: Identifying patterns and actionable insights</li>
                <li><strong>User Experience</strong>: Designing intuitive data exploration interfaces</li>
            </ul>
            
            <h4 style="color: #f8fafc !important;">🤝 Let's Connect</h4>
            </div>
            """, unsafe_allow_html=True)
            
            st.markdown("""
            <div class="social-links">
                <a href="https://www.linkedin.com/in/sanaj-jadhav/" class="social-btn">LinkedIn</a>
                <a href="https://github.com/sanajjadhav15" class="social-btn">GitHub</a>
                <a href="https://sanajjadhav.me/" class="social-btn">Portfolio</a>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            try:
                ...
                st.image("app/assets/profile.png", 
                         width=200,  
                ...
                st.markdown("""
                <div style="width: 200px; height: 200px; background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); 
    ...
    <div class="footer-text" style="text-align: center; padding: 2rem;">
        <p>“Data is the new oil, but like oil, it must be refined to be useful.”</p>
        <p>— Clive Humby</p>
    </div>
    """, unsafe_allow_html=True)
